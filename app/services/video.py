...
def combine_videos(
    ...
    for i, subclipped_item in enumerate(subclipped_items):
        ...
        try:
            ...
            is_xfade_mode = transition_value and str(transition_value).startswith("xfade:")
            if is_xfade_mode or transition_value in (None, VideoTransitionMode.none.value):
                pass
    ...
    is_xfade_mode = transition_value and str(transition_value).startswith("xfade:")
    if is_xfade_mode:
        xfade_effect = str(transition_value).split(":", 1)[1]
